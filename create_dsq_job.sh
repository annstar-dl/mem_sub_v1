...
dsq --job-file joblist.txt --mem=5G --cpus-per-task=5 --gres=gpu:1 -t 11:00 --partition=scavenge_gpu --mail-type ALL --output=/dev/null --batch-file="${JOB_ARRAY_NAME}_${TIMESTEMP}_dsq_job.sh"