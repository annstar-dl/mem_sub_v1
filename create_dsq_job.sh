...
python create_job_list.py -ddp ${DATASET_PATH} -sdp ./joblist.txt \
...
dsq --job-file joblist.txt --mem=5G --cpus-per-task=5 --gres=gpu:1 -t 11:00 --partition=scavenge_gpu --mail-type ALL --output=/dev/null