...
def create_job_list(data_dir_path, job_file_path, save_dir_path, nb_of_jobs, batch_size, seg_dir_path, file_mode,
                    save_angle_flag=0, save_sub_flag=0):
    """
    ...
    prefix = ("module reset; module load miniconda; conda activate ves_seg;"
        ...
        f"export PAR_FPATH={save_dir_path}/parameters.yml;"
        )
    ...
    if len(sub_dirs) > 0:
        for sub_dir in sub_dirs:
            ...
            create_job_list(data_dir_path=sub_dir, job_file_path=parsed_args.job_file_path,
                            ...
                            nb_of_jobs=parsed_args.nb_of_jobs, batch_size=batch_size,
                            seg_dir_path=parsed_args.seg_dir_path, file_mode="a",
                            save_angle_flag=parsed_args.save_angle_flag, save_sub_flag=parsed_args.save_sub_flag)
    else:
